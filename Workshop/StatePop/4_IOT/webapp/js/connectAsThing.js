...
const mqttEndpoint = "a2eshrcp6u0y0c.iot.us-east-1.amazonaws.com";
const SubscribeTopic = "$aws/things/waterPump/shadow/update/accepted";
const IdentityPoolId = 'us-east-1:861f79c1-9085-4e99-b8ce-a9c8d52fca34';
...
function onMessageArrived(message) {
    ...
    handleMessage(  // in updateDom.js, formerly updateReport
        JSON.stringify(
